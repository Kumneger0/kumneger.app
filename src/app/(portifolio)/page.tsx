...
//               👨‍💻 A passionate Full Stack Developer based in Ethiopia 🇪🇹 with experience in building applications with JavaScript / React / Node.js and some other cool libraries and frameworks.
//               I write about web development on my blog 🌐💡💻
//             </p>
...
//             <li>
//               <h3 className="text-2xl font-semibold"> Dynamo Center For Technology</h3>
//               <p>Role: Full Stack Developer</p>
//               <p>Duration: May 2023 - Present</p>
//               <p>Description: Worked on several web applications using React, Node.js, Express, and MongoDB. </p>
//             </li>
...
//               </Link>
//               <p>A deep dive into understanding React Hooks and how to use them in your applications.</p>
//             </li>
//             <li>
//               <Link className="underline text-blue-400" href="#">
//                 Demystifying GraphQL
//               </Link>
//               <p>A comprehensive guide to understanding and implementing GraphQL in your applications.</p>
//             </li>
//             <li>
//               <Link className="underline text-blue-400" href="#">
//                 Mastering TypeScript
//               </Link>
//               <p>Learn how to supercharge your JavaScript development with TypeScript.</p>
//             </li>
//           </ul>
//         </section>
//         <section className="mt-12">
